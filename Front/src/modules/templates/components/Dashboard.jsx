...
function Dashboard() {
  ...
  const renderLogoutButton = (mobile = false) => (
    <Button className={`${mobile ? 'block w-full sm:hidden' :  'hidden sm:block bg-red-50 text-red-600 hover:bg-red-100 px-5 py-2 rounded-lg text-sm font-semibold' }`} onClick={logout}>Cerrar sesión</Button>
  );
